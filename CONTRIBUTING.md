...
Welcome to
[xxJust](https://github.com/thereisnotime/xxJust)!
...
1.  If you are a first-time contributor:
    ...
    -   Go to
        [https://github.com/thereisnotime/xxJust](https://github.com/thereisnotime/xxJust)
        and click the `fork` button to create your own copy of the project.

    -   Clone the project to your local computer:
        ```
        git clone https://github.com/<your-username>/xxJust.git
        ```
    ...
    -   Add the upstream repository:
        ...
        ```
        git remote add upstream https://github.com/thereisnotime/xxJust.git
        ```
